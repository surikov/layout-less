...
class Vector3D {
    ...
    public void setNth(int n, double a) {
	p[n] = a;
    }
    /**
...
class Body3D {
     ...
     */
    public void addPolygon3D(Polygon3D p) {
	polygons.add(p);
    }
    /**
...
class World3D extends JPanel implements ActionListener {
    ...
    Vector3D viewpoint;
    public void setViewpoint(Vector3D vp) {
	viewpoint = vp;
    }
	...
	this.yMin = yMin;
	this.yMax = yMax;
	this.xPixWidth = width;
	this.yPixHeight = height;
	this.xPixOrigin = xPixOrigin;
	this.yPixOrigin = yPixOrigin;
