...
*/
	...
	layoutless
		...
		.item(new ComponentBox().component(fle
			.string(num.asNote()))
		...
		.item(new ComponentBox().component(nu.numeric(num))
		...
		.item(new ComponentBox().component(psw.text("111"))
		    .width(150)
		    .height(22)
		    .x(labelsWidth+8)
		    .y(8+25*2)
		    )
		.item(new ComponentBox().component(new SimpleNumericSlider(this).numeric(20))
		    .width(layoutless.width().minus(labelsWidth).minus(16))
		    .height(50)
		    .x(labelsWidth+8)
		    .y(8+25*3)
		    )
		.item(new ComponentBox().component(new SimpleCheck(this).text("test check"))
		    .width(layoutless.width().minus(labelsWidth).minus(16))
		    .height(22)
		    .x(labelsWidth+8)
		    .y(8+25*5)
		...
		.item(new ComponentBox().component(new SimpleTextField(this).text(bigTxt))
		    .width(layoutless.width().minus(labelsWidth).minus(16))
		    .height(70)
		    .x(labelsWidth+8)
		    .y(8+25*7)
		...
		.item(new ComponentBox().component(new SimpleLabel(this).text(mail.current()))
		    .width(layoutless.width().minus(labelsWidth).minus(16))
		    .height(120)
		    .x(labelsWidth+8)
		    .y(8+25*7+70+4+130)
		...
		.item(new ComponentBox().component(new SimpleWait(this).horizontal(false))
		    .width(16)
		    .height(100)
		    .x(8)
		    .y(8)
